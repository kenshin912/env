...
PigCMS env
This program is used for website which include Apache,MariaDB,PHP.
...
Uninstall:
run "PigCore/Uninstall.cmd" as administrator will uninstall automatically

How to use:
double cilck "Pig.cmd" will open console.

Requirement:
Microsoft Visual C++ 2008
7z(AutoBackUP.cmd need this)


License:
Copyright 2016 kenshin912
